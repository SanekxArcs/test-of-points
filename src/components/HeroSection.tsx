      ...
      <div className="flex h-full items-center max-w-480 mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:gap-12 w-full items-center">
          <div className="pl-5.5 md:pl-12.5 xl:pl-35 pt-12.5 w-full md:max-w-2/3 lg:max-w-full">
            <h1 className="text-[clamp(1.6875rem,4vw,4.25rem)] text-black text-balance leading-[121%] mb-2">
              Die Plattform für eine nachhaltige und vernetzte Energiezukunft
            </h1>
            <p className="text-[clamp(18px,4vw,32px)] text-white">The transition starts now.</p>
          </div>

          <div className="relative h-full w-full min-h-137.5 pl-25 md:pl-0 md:min-h-200 ml-auto xl:w-full md:w-2/3 lg:min-h-138.5 pb-25 lg:pb-0 xl:min-h-210 2xl:min-h-238.5 mask-r-from-90%">
            <InteractivePoints />
          </div>
        </div>
      </div>
      <div className="hidden bottom-4 left-1/2 transform -translate-x-1/2 animate-bounce lg:absolute">
